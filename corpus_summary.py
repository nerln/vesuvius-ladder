...
def main() -> int:
    ...
    if tot["separation"]:
        ...
        # No ratio between these two is printed. With a single positive it would be
        # a statistic over n=1; the useful claim is that the band around the
        # threshold is empty, which does not depend on how many positives there are.
